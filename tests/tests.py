...
class MainTestEngine (TestEngine):
    ...
    def test_pupil_name_exists(self):
      self.assertEqual(pupil_name, "Bob Jones", f"\nIncorrect value for pupil_name variable")
